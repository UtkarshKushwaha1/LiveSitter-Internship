...
if __name__ == '__main__':
    ...
    path2 = './runs/detect/exp/'

    # imgs = ['data/images/zidane.jpg',  Path('data/images/zidane.jpg'),  'https://ultralytics.com/images/zidane.jpg', 
    #     cv2.imread('data/images/bus.jpg')[:, :, ::-1],  # OpenCV
    #     Image.open('data/images/bus.jpg'),  # PIL
    #     np.zeros((320, 640, 3))]  # numpy
    for img in imgs:
        i = path+img
        results = model(i, size=320)  # batched inference
        results.print()
        results.save()
